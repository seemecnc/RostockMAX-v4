...
; mechanical delta parameters -> delta radius, diagonal rod length, printable radius and homed height
M665 R144 L291.06 B135 H400 X0 Y0 Z0       ; standard injection molded arms
;M665 R144 L337 B135 H400 X0 Y0 Z0         ; optional carbon fiber arm settings
...
M558 P5 I0 A2 S0.05 R0.4 H20 F800          ; Strain gage probe settings
